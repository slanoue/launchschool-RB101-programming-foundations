...
# It is often the case that two different things "look the same", but they can be different
# objects. The "under the hood" object referred to by a particular named-variable can change 
